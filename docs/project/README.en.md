...
**Related docs:** [Phase 1 design](phase1-design.en.md), [Network concept](network-concept.en.md), [Sample app plan (chat + file sharing)](sample-chat-app-plan.en.md), [Gitcoin funding procedure](gitcoin-funding.en.md).
