...
| **Network** | Set of member DIDs (1+). 1-to-1 is a 2-person network. Member list and roles are stored locally on each node. See [Network concept](network-concept.en.md). |
